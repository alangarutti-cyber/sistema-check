...
migrate((app) => {
  ...
  const corrective_actionsCollection = app.findCollectionByNameOrId("corrective_actions");
  ...
  const collection = new Collection({
    ...
    "fields":     [
          ...
          },
          {
                ...
                "type": "relation",
                "cascadeDelete": false,
                "collectionId": corrective_actionsCollection.id,
                "displayFields": [],
                "maxSelect": 1,
                "minSelect": 0
          },
  ...
  try {
    const collection = app.findCollectionByNameOrId("pbc_4250079242");
